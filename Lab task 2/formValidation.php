...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  ...
  <span style = "display:inline-block; width:250px;text-align:right;"><b>NAME:</b></span> 
  <input type="text" name="name" value="<?php echo $name;?>">
  <span class="error">* <?php echo $nameErr;?></span>
  <br><br>

  <span style = "display:inline-block; width:250px;text-align:right;"><b>EMAIL:</b></span> 
  <input type="text" name="email" value="<?php echo $email;?>">
  <span class="error">* <?php echo $emailErr;?></span>
  <br><br>
  
  <span style = "display:inline-block; width:250px;text-align:right;"><b>DATE OF BIRTH:</b></span>  
  <input type="DATE" name="dateOfBirth" value="<?php echo $dateOfBirth;?>">
  <span class="error">* <?php echo $dateOfBirthErr;?></span>
  <br><br>

  <span style = "display:inline-block; width:250px;text-align:right;"><b>GENDER:</b></span> 
  ...
  <span style = "display:inline-block; width:250px;text-align:right;"><b>DEGREE:</b></span> 
  ...
  <span style = "display:inline-block; width:250px;text-align:right;"><b>BLOOD GROUP:</b></span> 
